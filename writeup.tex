...
% take 1 rd that costs 10 as opposed to 10 rds that cost 1
% undervalue costs...ie why do you make everything cost systemically less in your mind

% systemically thinking about high cost
% thinking in percentage saving
% person might be very enthusiastic about taking a new drug that
% reduces their risk of contracting a disease from 5% to 1%, but much less enthusiastic about a new drug that reduces their risk from 50% to 46%
...
\begin{proof}
  ...
  \begin{align*}
    ...
    %&= a^\beta \sum_{e \in s_i} c_e\pbet(x_e) \\
...
% In the paper, we bounded the lowball price of anarchy, which helped understand the worst case in congestion games with agents who undervalued costs.  We'd also like to look at agents in congestions games under other behavioral biases, like overweighing small probabilities, another concept put forth by prospect theory.
