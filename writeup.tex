...
\begin{abstract}
  ...
  they systematically undervalue them in a nonlinear fashion
  ...
  biased agents and the social optimum grows with the size of the game. Roughly
  speaking, our findings indicate that people misunderstand the additivity of
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \begin{tikzpicture} [baseline=(s.base), arc/.style={->,thick,>=stealth},
      ...
      \draw [arc,bend left=40] (s) to node [auto] {$3\cdot 2^\beta$} (t);
    \end{tikzpicture}
